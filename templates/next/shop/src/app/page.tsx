...
export default function Page() {
  return (
    <main className="min-h-dvh bg-[#fcfaf8] text-[#2b2a2a] antialiased">
      ...
      <header className="sticky top-0 z-40 bg-[#fcfaf8]/90 backdrop-blur supports-[backdrop-filter]:bg-[#fcfaf8]/60">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src="/logo.png" alt="" className="h-9 w-9 object-contain rounded-full" />
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10 text-center">
          <div>
            ...
            <p className="text-gray-600 text-sm">
              Enable payments through M-Pesa, Visa, or MasterCard when you&rsquo;re ready.
            </p>
          </div>
          <div>
            <div className="mx-auto mb-4 h-20 w-20 text-[#437a3a]">
      ...
      {/* Products grid (dynamic, unchanged) */}
        ...
        <div className="max-w-6xl mx-auto grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          {[1,2,3,4,5,6].map(i => (
            <div key={i} className="rounded-lg border border-[#eee] bg-white p-4 hover:shadow-md transition">
              ...
              <a
                href={whatsappRR(`Hi, I&rsquo;m interested in Product ${i}.`)}
                target="_blank"
                rel="noopener"
      ...
      <section id="contact" className="py-20 bg-[#fffdfb] text-center scroll-mt-24">
        ...
        <p className="text-gray-600 mb-8">
          We&rsquo;ll set up your store template and connect your WhatsApp — ready to sell in days.
        </p>
        <a
          href={whatsappRR("Hi! I&rsquo;d like to get started with the Shop template.")}
          target="_blank"
          rel="noopener"
